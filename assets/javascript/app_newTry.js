...
function createQuiz(){
                ...
                console.log("Total  Questions before create Quiz " +  totalQuestions);
                console.log("Current Question before create Quiz " +  currentQuestion);
   ...
   $("#startGame").on("click", function(){
    ...
    //on page load click on start game to start the game time and create quiz for 1st question.
                    ...
                    createQuiz();
                     ...
                     //currentQuestion++;
                     //totalQuestions--;
                     console.log("Total  Questions on ANS click " +  totalQuestions);
                     console.log("Current Question on ANS click " +  currentQuestion);              
...
/*
                     if(totalQuestions > 0){
                      //call a function to calculate stats
                      //call the function to display results and image
                      //stop the timer for currentQuestion
                      //set the triviaTime to 15


                     }

                     else if (totalQuestions===0){
                      //display Stats() call function
                      //
